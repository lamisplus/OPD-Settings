...
import { useSaveOpdSetting } from "../../../hooks/useSaveOpdSetting";
...
const OpdSettingCreateForm = (props) => {
  ...
  const { mutate, isLoading } = useSaveOpdSetting(formik, props);
...
export default OpdSettingCreateForm;

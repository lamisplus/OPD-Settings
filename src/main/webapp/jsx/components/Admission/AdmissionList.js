...
const Patients = (props) => {
  ...
  const VaccinationStatusIcon = (patient) => {
    if (patient.vaccination_status === "") {
      return (
        <>
          <Icon name="dot circle outline" color="yellow" />
      ...
      return (
        <>
          <Icon name="dot circle outline" color="green" />
          {patient.first_name + " " + patient.last_name}
        </>
      );
    } else {
                  ...
                  <Menu>
                    ...
                    <MenuList style={{ color: "#000000 !important" }}>
                      ...
                      <MenuItem style={{ color: "#000 !important" }}>
                        ...
                        >
                          <FaUserEdit size="15" color="black" />{" "}
                          <span style={{ color: "#000" }}>Edit Patient</span>
                        </Link>
                      </MenuItem>
                      <MenuItem
                        style={{ color: "#000 !important" }}
                        onClick={() => loadTransferModal(row)}
                      >
                        <FaShare size="15" />{" "}
                      ...
                      <MenuItem
                        style={{ color: "#000 !important" }}
                        onClick={() => loadVaccinationModal(row)}
                      >
                        <FaSyringe size="15" />{" "}

...
function AddmissionHome(props) {
  ...
  const getVitalsHistory = () => {
    axios
      .get(
        `${baseUrl}covid/encounters/${patientObj.id}/ADMISSION_VITAL_SIGNS`,
        { headers: { Authorization: `Bearer ${token}` } }
      )
      .then((response) => {
  ...
  return (
    <div className={classes.root}>
            ...
            <Grid.Column>
              <Segment raised>
                ...
                <Icon
                  ...
                  onClick={() => loadInclusionCriteriaModal()}
                />
                <List divided verticalAlign="middle">
                  {inclusionHistory !== "" &&
                    inclusionHistory.map((value) => (
                      <>
                        <List.Item>
                          ...
                          <List.Content>
                            Encounter Date {"  " + value.visit_date}
                          </List.Content>
                        </List.Item>
                      </>
                    ))}
            ...
            <Grid.Column>
              <Segment>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => DemographicModal()}
                />
                <List divided verticalAlign="middle">
                  {demograhicHistory !== "" &&
                    demograhicHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
            ...
            <Grid.Column>
              <Segment raised>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => ViccinationModal()}
                />
                <List divided verticalAlign="middle">
                  {vaccinationHistory !== "" &&
                    vaccinationHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
                          ...
                          <Icon name="info circle" />
                          <List.Content>
                            Date Vaccinated {"  " + value.visit_date}
                          </List.Content>
                        </List.Item>
                      </>
                    ))}
            ...
            <Grid.Column>
              <Segment>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => VitalSignModal()}
                />
                <List divided verticalAlign="middle">
                  {vitalHistory !== "" &&
                    vitalHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
            ...
            <Grid.Column>
              <Segment raised>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => ComorbitieModal()}
                />
                <List divided verticalAlign="middle">
                  {comobitieHistory !== "" &&
                    comobitieHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
            ...
            <Grid.Column>
              <Segment>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => ReInfectionModal()}
                />
                <List divided verticalAlign="middle">
                  {reinfectionHistory !== "" &&
                    reinfectionHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
            ...
            <Grid.Column>
              <Segment raised>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => SignsSymptomsModal()}
                />
                <List divided verticalAlign="middle">
                  {signsSymptomsHistory !== "" &&
                    signsSymptomsHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
            ...
            <Grid.Column>
              <Segment>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => ChronicMedicationModal()}
                />
                <List divided verticalAlign="middle">
                  {chronicMedicationHistory !== "" &&
                    chronicMedicationHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
            ...
            <Grid.Column>
              <Segment raised>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => MedicationModal()}
                />
                <List divided verticalAlign="middle">
                  {medicationHistory !== "" &&
                    medicationHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
            ...
            <Grid.Column>
              <Segment>
                ...
                <Icon
                  ...
                  className=" float-end ms-1"
                  style={{ cursor: "pointer" }}
                  onClick={() => SupportiveCareModal()}
                />
                <List divided verticalAlign="middle">
                  {supportiveCarenHistory !== "" &&
                    supportiveCarenHistory.map((value) => (
                      <>
                        <List.Item>
                          <List.Content floated="right">
                            <Label>View</Label>
      ...
      <InclusionCriteria
        toggle={inclusionCriteriaToggle}
        showModal={inclusionCriteriaModal}
        patientObj={patientObj}
        getInclusionHistory={getInclusionHistory}
      />
      <Demographic
        toggle={demographicToggle}
        showModal={demographicModal}
        patientObj={patientObj}
        getDemographicHistory={getDemographicHistory}
      />
      <Viccination
        toggle={ViccinationToggle}
        showModal={viccinationModal}
        patientObj={patientObj}
        getVaccinationHistory={getVaccinationHistory}
      />
      <VitalSign
        toggle={VitalSignToggle}
        showModal={vitalSignModal}
        patientObj={patientObj}
        getVitalsHistory={getVitalsHistory}
      />
      <Comorbitie
        toggle={ComorbitieToggle}
        showModal={comorbitieModal}
        patientObj={patientObj}
        getComobitieHistory={getComobitieHistory}
      />
      <ReInfection
        toggle={ReinfectionToggle}
        showModal={reInfectionModal}
        patientObj={patientObj}
        getReinfectionHistory={getReinfectionHistory}
      />
      <ChronicMedication
        toggle={ChronicMedicationToggle}
        showModal={chronicMedicationModal}
        patientObj={patientObj}
        getChronicMedicationHistory={getChronicMedicationHistory}
      />
      <Medication
        toggle={MedicationToggle}
        showModal={medicationModal}
        patientObj={patientObj}
        getMedicationHistory={getMedicationHistory}
      />
      <SignsSymptoms
        toggle={SignsSymptomsToggle}
        showModal={signsSymptomsModal}
        patientObj={patientObj}
        getSignsSymptomsHistory={getSignsSymptomsHistory}
      />
      <SupportiveCare
        toggle={SupportiveCareToggle}
        showModal={supportiveCareModal}
        patientObj={patientObj}
        getSupportiveCareHistory={getSupportiveCareHistory}
      />
    </div>
  );
}
